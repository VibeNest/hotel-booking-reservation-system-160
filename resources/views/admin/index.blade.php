...
@php
    ...
    $todayPrice = App\Models\Booking::whereDate('created_at', $today)->where('payment_status', '1')->sum('total_price');
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13">Total bookings received</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13">Total bookings pending</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13">Total bookings complete</p>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                ...
                                <p class="mb-0 font-13">Today Sale: <span
                                        class="text-success"><strong>${{ $todayPrice }}</strong></span></p>
                            </div>
