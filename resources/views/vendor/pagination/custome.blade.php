@if ($paginator->hasPages())
    ...
    @if ($paginator->onFirstPage())
        <a class="disabled prev page-numbers" aria-disabled="true" aria-label="@lang('pagination.previous')">
    ...
    @if ($paginator->hasMorePages())
        <a class="next page-numbers" href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')"><i
