    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('update.blog.post') }}" enctype="multipart/form-data" class="row g-3">
                    @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="blog_cat_id" name="blog_cat_id" class="form-select">
                            ...
                            @foreach ($blog_cat as $cat)
                                <option value="{{ $cat->id }}" {{ $cat->id == $post->blog_cat_id ? 'selected' : '' }}>
                                    {{$cat->category_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="myeditorinstance" name="long_desc"
                            rows="3">{{ $post->long_desc}}</textarea>
                    </div>

                    <div class="col-md-6">
                        <label for="image" class="form-label">Post Image</label>
                        <input type="file" id="image" name="post_image" class="form-control" accept="image/*">
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-9 text-secondary form-group">
                            <img id="showImage" src="{{asset($post->post_image)}}" alt="{{$post->post_title}}"
