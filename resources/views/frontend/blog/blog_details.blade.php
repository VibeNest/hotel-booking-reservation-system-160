            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog-article">
                        ...
                        @php
                            $comments = App\Models\Comment::where('post_id', $blog->id)->where('status', '1')->limit(5)->get();
                        @endphp
                        ...
                        <div class="comments-wrap">
                            ...
                            <ul>
                                @foreach ($comments as $comment)
                                    <li>
                                        <img src="{{ (!empty($comment->user->photo)) ? url("upload/user_images/{$comment->user->photo}") : url("upload/no_image.jpeg")}}"
