...
@section("admin")
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Create Add-on</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('store.addon') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">Name</label>
                            <input type="text" name="name" class="form-control" placeholder="Enter Add-on Name" required>
                        </div>
                        <div class="mb-3">
