                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-primary" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#roomManage" role="tab"
                                        aria-selected="true">
                                        <div class="d-flex align-items-center">
                                            <div class="tab-icon"><i class="bx bx-bed font-18 me-1"></i></div>
                            ...
                            <div class="tab-content py-3">
                                <div class="tab-pane fade show active" id="roomManage" role="tabpanel">
                                    <div class="card">
                                        <div class="card-body p-4">
                                            ...
                                            <form class="row g-3" method="POST"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea name="short_desc" class="form-control" id="myeditorinstance"
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-md-12 mb-3">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <select name="facility_name[]" id="facility_name"
                                                                            ...
                                                                            <option value="Laundry & Dry Cleaning"
                                                                                {{$item->facility_name == 'Laundry & Dry Cleaning' ? 'selected' : ''}}>Laundry & Dry Cleaning
                                                                            </option>
                                                        ...
                                                        @empty
                                                            ...
                                                            <div class="basic_facility_section_remove initial_facility_row"
                                                                id="basic_facility_section_remove">
                                                                <div class="row add_item">
                                                                    <div class="col-md-6">
                                                                        <label for="facility_name" class="form-label">Room
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", ".removeeventmore", function (event) {
                let currentSection = $(this).closest(".basic_facility_section_remove");

                if (currentSection.hasClass("initial_facility_row")) {
                    currentSection.find("select").val("");
                    return;
                }
